...
class AgentLightningModule(pl.LightningModule):
    ...
    def predict_step(
        ...
        elif isinstance(self.agent, DRSIAgent):
            return self.predict_step_drsi(batch, batch_idx)
        else:
    ...
    def on_train_epoch_end(self) -> None:
        ...
        if isinstance(self.agent, DRSIAgent):
            self.agent.model.build_vocab_cache()
